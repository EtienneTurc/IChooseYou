...
from server.service.formatter.interactivity import (
    ...
    format_main_modal_clean_deleted_users_payload,
...
BLUEPRINT_INTERACTIVITY_ACTION_TO_DATA_FLOW = {
    ...
    BlueprintInteractivityAction.MAIN_MODAL_CLEAN_DELETED_USERS.value: DataFlow(
        formatter=format_main_modal_clean_deleted_users_payload,
    ...
    BlueprintInteractivityAction.MAIN_MODAL_XMAS_CELEBRATION.value: DataFlow(
        formatter=format_main_modal_base_payload,
