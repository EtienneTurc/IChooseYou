...
def delete_message_processor(
    *, user_id: str, channel_id: str, ts: str, team_id: str, message_text: str, **kwargs
) -> dict[str, any]:
...
def resubmit_command_and_delete_message_processor(**kwargs) -> dict[str, any]:
    delete_message_processor(**kwargs)
