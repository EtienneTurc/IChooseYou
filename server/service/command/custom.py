...
from server.service.command.args import ArgError, ArgumentParser
...
from server.service.command.validator import assert_named_args, assert_positional_args
...
class CustomCommand:
    ...
    def exec(self, user, args_text, **kwargs):
        ...
        return Message(
            content=format_custom_command_message(user, selected_element, label),
